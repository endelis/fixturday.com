    ...
    <>
      ...
      <div className="container" style={{ paddingTop: '2rem', maxWidth: '1100px' }}>
        ...
        {ageGroupBrackets.map(({ ageGroup, rounds }) => (
          <div key={ageGroup.id} style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', overflowX: 'auto', paddingBottom: '0.5rem', alignItems: 'flex-start' }}>
              {rounds.map(({ roundNum, roundName, matches }) => (
                <div key={roundNum} style={{ minWidth: '180px', flex: '0 0 180px' }}>
                  <div style={{
                      ...
                      return (
                        ...
                        >
                          <div style={{
                            ...
                            {hasResult && (
                              <span style={{ fontWeight: 700, minWidth: '1.5rem', textAlign: 'right' }}>
                                {homeGoals}
                              </span>
                            )}
                          </div>
