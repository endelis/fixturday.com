...
const PublicPlayoff   = lazy(() => import('./pages/Public/Playoff'))
...
<Route path="/tournament-bracket-generator"        element={<TournamentBracketGenerator />} />
          ...
          <Route path="/t/:slug/:ageGroup/playoff"             element={<PublicPlayoff />} />
          <Route path="/t/:slug/:ageGroup/teams"              element={<PublicTeams />} />
